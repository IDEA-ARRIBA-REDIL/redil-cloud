...
use App\Http\Controllers\Cumpleanos;
...
use App\Livewire\Taquilla\GestionTaquilla;
...
Route::middleware(['auth', 'verified'])->group(function () {
  ...
  /// niveles
  Route::get('/niveles/{escuela}/crear', [NivelEscuelaController::class, 'crear'])->name('niveles.crear');
  Route::get('/niveles/{escuela}/listar', [NivelEscuelaController::class, 'listar'])->name('niveles.listar');
  Route::get('/niveles/{nivel}/editar', [NivelEscuelaController::class, 'editar'])->name('niveles.editar');
  Route::get('/niveles/{materia}/horarios', [NivelEscuelaController::class, 'horariosMateria'])->name('niveles.horariosMateria');
  Route::get('/niveles/{nivel}/materias', [NivelEscuelaController::class, 'materias'])->name('niveles.materias');
  Route::post('/niveles/{nivel}/crear-horario', [NivelEscuelaController::class, 'crearHorario'])->name('niveles.crearHorario');
  Route::post('/niveles/{nivel}/crear-materia', [NivelEscuelaController::class, 'crearMateria'])->name('niveles.crearMateria');
  Route::post('/niveles/{escuela}/guardar', [NivelEscuelaController::class, 'guardar'])->name('niveles.guardar');
  Route::post('/niveles/{nivel}/actualizar', [NivelEscuelaController::class, 'actualizar'])->name('niveles.actualizar');

  // Niveles Agrupados (Nuevo Sistema)
  Route::get('/niveles-agrupados/{escuela}/index', [NivelAgrupacionController::class, 'index'])->name('escuelas.niveles.index');
  Route::get('/niveles-agrupados/{escuela}/crear', [NivelAgrupacionController::class, 'create'])->name('escuelas.niveles.crear');
  Route::post('/niveles-agrupados/{escuela}/store', [NivelAgrupacionController::class, 'store'])->name('escuelas.niveles.store');
  Route::get('/niveles-agrupados/{nivel}/gestionar-materias', [NivelAgrupacionController::class, 'gestionarMaterias'])->name('escuelas.niveles.gestionar-materias');

  // Matrícula Niveles Agrupados
  Route::get('/matricula-niveles/{escuela}/seleccionar', [\App\Http\Controllers\MatriculaNivelController::class, 'seleccionarNivel'])->name('matriculas.niveles.seleccionar');
