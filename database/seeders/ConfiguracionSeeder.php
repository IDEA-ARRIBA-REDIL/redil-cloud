...
class ConfiguracionSeeder extends Seeder
{
  ...
  public function run(): void
  {
    Configuracion::firstOrCreate([
      ...
      'mensaje_bienvenida' => '<p>Hemos registrado tus datos personales en nuestra plataforma y ahora eres de los nuestros <br> También hemos creado para ti, una cuenta con la cual podrás enterarte y disfrutar de los servicios que te ofrecemos en la iglesia.</p>',
    ...
    /*
    Configuracion::firstOrCreate([
      'dias_plazo_reporte_grupo' => 3,
      'reportar_grupo_cualquier_dia' => 0,
      'version' => 1,
      'sumar_encargado_asistencia_grupo' => 1,
      'dia_corte_reportes_grupos' => 5,
      'nombre_informacion_opcional' => 'Datos complementarios',
      'identificacion_obligatoria' => 1,
      'usa_listas_geograficas' => true,
      'usa_modal_asistente_liviano' => 1,
      'nombre_campo_reservado' => 'Observaciones especiales',
      'valor_minimo_resaltador_informe_mensual_reportes_grupo' => 10,
      'valor_maximo_resaltador_informe_mensual_reportes_grupo' => 100,
      'tiempo_para_definir_inactivo_grupo' => 7,
      'tiempo_para_definir_inactivo_reunion' => 7,
      'identificacion_solo_numerica' => 1,
      'reestructuracion_asistentes_grupos' => 0,
      'edad_minima_logueo' => 14,
      'direccion_obligatoria' => 1,
      ...
      'habilitar_observacion_anadir_invitados_modal' => 0,
      'text_default_observacion_invitados_modal' => null,
      'label_seccion_campos_extra' => 'Datos adicionales',
      'visible_seccion_campos_extra' => 1,
      'asistente_pertenece_a_varios_grupos' => 1,
      'visible_seccion_campos_extra_grupo' => 1,
      'maximos_niveles_grafico_ministerio' => 2,
      'mensaje_bienvenida' => '<p>¡Bienvenido! Ya haces parte de nuestra comunidad.</p>',
      'titulo_mensaje_bienvenida' => '¡Gracias por unirte!',
      'banner_mensaje_bienvenida' => true,
      'espacio_academico_habilitado' => 1,
      'cantidad_intentos_auto_matricula' => 3,
      'dias_plazo_maximo_actualizacion_automatricula' => 3,
      'moneda_predeterminada_punto_pago' => 1,
      'mensaje_correo_punto_pago' => null,
      'label_fecha_creacion_grupo' => null,
      'fecha_inicio_ejecucion_llenar_grupos_de_grupo' => '2024-12-14 01:00:02',
      'fecha_fin_ejecucion_llenar_grupos_de_grupo' => '2024-12-14 01:00:02',
      'habilitar_salones_con_estaciones' => 1,
      'items_mixtos_escuelas_deshabilitados' => 1,
      'cierre_cortes_habilitado' => 1,
      'habilitar_traslados' => 1,
      'cantidad_dias_alerta_notas_maestro' => 12,
      'ruta_almacenamiento' => 'iglesia2',
      'nombre_app_personalizado' => 'Crecer'
    ]);*/
  }
}
