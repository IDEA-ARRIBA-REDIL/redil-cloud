...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function nivelesAprobados()
    {
        return $this->hasMany(NivelAprobadoUsuario::class, 'user_id');
    }

    public function pasosCrecimiento(): BelongsToMany
    {
        return $this->belongsToMany(PasoCrecimiento::class, 'crecimiento_usuario', 'user_id', 'paso_crecimiento_id')
            ->using(CrecimientoUsuario::class)
            ->withPivot(
                'estado_id',
                'fecha',
                'detalle',
    ...
    public function bitacoraCrecimiento(): HasMany
    {
        return $this->hasMany(BitacoraCrecimientoUsuario::class, 'user_id');
    }
