...
class InscripcionConfirmacionMail extends Mailable
{
    ...
    {
        $subject = match ((int) $this->actividad->estado_inscripcion_defecto) {
            1 => 'Tu proceso de inscripción ha iniciado: '.$this->actividad->nombre,
            2 => 'Tu proceso de inscripción está pendiente por confirmar: '.$this->actividad->nombre,
            default => 'Confirmación de Inscripción: '.$this->actividad->nombre,
        };
