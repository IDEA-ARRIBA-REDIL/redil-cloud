...
{
    /**
     * Muestra el listado de niveles de una escuela.
     * Solo accesible si la escuela es de tipo 'niveles_agrupados'.
     */
    ...
    /**
     * Almacena un nuevo nivel y su configuración inicial completa.
     */
    public function store(Escuela $escuela, Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'tipo_usuario_objetivo_id' => 'nullable|exists:tipo_usuarios,id',
        ...
        try {
            ...
            $configuracion = new NivelAgrupacionConfiguracion([
                ...
                'tipo_usuario_objetivo_id' => $request->tipo_usuario_objetivo_id,
    ...
    /**
     * Muestra la gestión de materias del nivel.
     */
    public function gestionarMaterias(NivelAgrupacion $nivel)
    {
        // Cargar materias asignadas y disponibles
        $nivel->load('materias', 'escuela.materias');

        return view('contenido.paginas.escuelas.niveles.gestionar-materias', compact('nivel'));
    }
}
