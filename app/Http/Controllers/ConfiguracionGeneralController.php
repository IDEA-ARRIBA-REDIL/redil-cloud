...
class ConfiguracionGeneralController extends Controller
{
    ...
    public function actualizar(Request $request)
    {
        ...
        // --- Procesamiento de Archivos (Logo / Logo Negro / Favicon) ---
        ...
        if ($request->filled('logo_negro_base64')) {
            ...
            // Eliminar el logo negro anterior si existe para evitar archivos huérfanos
            if ($configuracion->logo_app_negro && Storage::exists($pathBranding.'/'.$configuracion->logo_app_negro)) {
                Storage::delete($pathBranding.'/'.$configuracion->logo_app_negro);
            }

            $datos['logo_app_negro'] = $fileName;
        }
