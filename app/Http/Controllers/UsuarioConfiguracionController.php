...
class UsuarioConfiguracionController extends Controller
{
    ...
    public function crear(Request $request)
    {
        ...
        $data['seguimiento_para_dar_de_baja_automaticamente'] = $request->has('seguimiento_para_dar_de_baja_automaticamente') ? 1 : 0;
    ...
    public function actualizar(Request $request, TipoUsuario $tipoUsuario)
    {
        ...
        $tipoUsuario->seguimiento_para_dar_de_baja_automaticamente = $request->has('seguimiento_para_dar_de_baja_automaticamente');
