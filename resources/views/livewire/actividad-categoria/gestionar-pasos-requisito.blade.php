<div>
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Pasos de Crecimiento - Requisitos (Nivel Categoría)</h5>
            <p class="text-muted small mb-0">Configura los pasos que el usuario debe tener completados para inscribirse en esta categoría</p>
        </div>
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button
                                            ...
                                            wire:confirm="¿Estás seguro de eliminar este paso requisito?"
            ...
            @else
                <div class="alert alert-info mb-0">
                    ...
                    No hay pasos de crecimiento configurados como requisito para esta categoría.
                </div>
            @endif
        </div>
    </div>
