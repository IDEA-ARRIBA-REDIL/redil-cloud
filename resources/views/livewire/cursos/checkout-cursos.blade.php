                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label text-muted small fw-medium">Identificación
                                        (Cédula/NIT)</label>
                                ...
                                <div class="alert alert-warning mb-0 border-0 shadow-sm"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small>Los cursos seleccionados en tu carrito no tienen métodos de pago
                                                habilitados. Por favor, contacta con soporte o con el
                                                administrador.</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    @foreach ($tiposPagoDisponibles as $tipo)
                                        <div class="col-md-6">
                                            <div class="form-check custom-option custom-option-basic border rounded-3 p-2 bg-white {{ $tipoPagoSeleccionado == $tipo->id ? 'border-primary shadow-sm' : '' }}"
                                                ...
                                                <label class="form-check-label p-2 w-100 d-flex align-items-center"
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <span
                                                            class="d-block fw-bold text-dark">{{ $tipo->nombre }}</span>
                                                        <small class="text-muted">Paga de forma segura</small>
                                                    </div>

                                                    <i
                                                        class="ti ti-check ms-auto text-primary fs-4 {{ $tipoPagoSeleccionado == $tipo->id ? 'd-block' : 'd-none' }}"></i>
                                                </label>
                                            </div>
                                        </div>
                                    @endforeach
                            ...
                            @if ($carrito)
                                ...
                                @auth
                                    <button wire:click="procesarPago" wire:loading.attr="disabled"
                                        ...
                                        <span wire:loading wire:target="procesarPago"><i
                                                class="ti ti-loader ti-spin me-2"></i>
                                            Procesando...</span>
                                    </button>
                                @else
                                    <a href="{{ route('login') }}"
