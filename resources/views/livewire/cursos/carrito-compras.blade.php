                ...
                <div class="col-lg-8 mb-4">
                    <div class="card border-0 shadow-sm rounded-4">
                        <div
                            ...
                            <span class="badge btn-primary text-white rounded-pill px-3 py-2">{{ count($items) }}
                                Ítems</span>
                        </div>
                                    ...
                                    <table class="table table-borderless align-middle mb-0">
                                        <thead class="border-bottom">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-muted small fw-medium pb-3 text-end">
                                                    PRECIO
                                                </th>
