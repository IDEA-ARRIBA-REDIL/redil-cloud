  ...
  <form id="formulario" role="form" class="forms-sample" method="POST" action="{{ route('tema.crear') }}"  enctype="multipart/form-data" >
    ...
    <div class="col-md-12">
      <div class="card mb-4 rounded rounded-3">
        <img id="preview-foto" class="cropped-img card-img-top mb-2" src="{{ Storage::disk('global_media')->url('temas/default.png') }}" alt="Portada">
        ...
        <div class="row p-4 m-0 d-flex card-body">
          ...
          <p class="mb-4 text-black">Aquí podras ingresar un nuevo tema, por favor llena los campos que son requeridos.</p>
        </div>
      </div>
    </div>
    <!-- PORTADA -->
