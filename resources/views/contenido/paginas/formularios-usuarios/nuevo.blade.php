...
@section('content')
<h4 class="mb-1 fw-semibold text-primary">Nuevo formulario</h4>
<p class="mb-8">Aquí podrás crear y configurar un formulario.</p>

@include('layouts.status-msn')

<form id="formulario" role="form" class="forms-sample" method="POST" action="{{ route('formularioUsuario.crear') }}"  enctype="multipart/form-data" >
  @csrf
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="mb-3 col-12 col-md-4">
            ...
            <input id="nombre" name="nombre" placeholder="Escribe el nombre" value="{{ old('nombre') }}" type="text" class="form-control" />
          ...
          <div class="mb-3 col-12 col-md-4">
            ...
            <input id="titulo" name="título" placeholder="Escribe el título" value="{{ old('título') }}" type="text" class="form-control" />
          ...
          <div class="mb-3 col-12 col-md-4">
            ...
            <input id="etiqueta" name="etiqueta" placeholder="Escribe la etiqueta" value="{{ old('etiqueta') }}" type="text" class="form-control" />
          ...
          <div class="mb-3 col-12">
            ...
            <textarea onkeypress="return sinComillas(event)" id="descripcion" name="descripción" placeholder="Escribe una descripción breve" class="form-control" rows="2" maxlength="500" spellcheck="false" data-ms-editor="true" >{{ old('descripción') }}</textarea>
          ...
          <div class="mb-3 col-12 col-md-4">
            ...
            <select id="tipoDeFormulario" name="tipoDeFormulario" class="select2 form-select" data-allow-clear="true">
              <option value="" selected>Ninguno</option>
              @foreach ($tipos as $tipo)
              <option value="{{$tipo->id}}" {{ old('tipoDeFormulario') == $tipo->id ? 'selected' : '' }} data-es-formulario-exterior="{{ $tipo->es_formulario_exterior }}" data-es-formulario-nuevo="{{ $tipo->es_formulario_nuevo }}">{{$tipo->nombre}} </option>
              @endforeach
            </select>
          ...
          <div class="mb-3 col-12 col-md-8">
            ...
            <select id="roles" name="roles[]" multiple class="select2Iconos form-select">
          ...
          <div class="mb-3 col-12 col-md-4">
            ...
            <select id="tipoUsuarioPorDefecto" name="tipoUsuarioPorDefecto" class="select2 form-select" data-allow-clear="true">
              <option value="" selected>Ninguno</option>
              @foreach ($tiposUsuario as $tipo)
              <option value="{{$tipo->id}}" {{ old('tipoUsuarioPorDefecto') == $tipo->id ? 'selected' : '' }}">{{$tipo->nombre}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-3 col-12 col-md-4">
            ...
            <select id="sedeDefault" name="sedeDefault" class="select2 form-select" data-allow-clear="true">
              ...
              <option value="{{$sede->id}}" {{ old('sedeDefault') == $sede->id ? 'selected' : '' }}>{{$sede->nombre}}</option>
              @endforeach
            </select>
        ...
        <div class="row">
          ...
          <div class="mb-3 col-12 col-md-4">
            ...
            <label class="switch switch-lg">
              <input id="validarEdad" name="validarEdad" placeholder="Validar edad" type="checkbox" @checked(old('validarEdad')) class="switch-input switchTerminosCondiciones" />
          ...
          <!-- edadMinima -->
          <div id="divEdadMinima" class="mb-3 col-12 col-md-4 {{ old('validarEdad') ? '' : 'd-none' }}">
            <label class="form-label" for="edadMinima">
              Edad mínima
            </label>
            <input id="edadMinima" name="edadMínima" placeholder="Escribe la edad mínima" value="{{ old('edadMínima') }}" type="number" class="form-control" />
          ...
          <!-- edadMaxima -->
          <div id="divEdadMaxima" class="mb-3 col-12 col-md-4 {{ old('validarEdad') ? '' : 'd-none' }}">
            <label class="form-label" for="edadMaxima">
              Edad maxima
            </label>
            <input id="edadMaxima" name="edadMaxima" placeholder="Escribe la edad maxima" value="{{ old('edadMaxima') }}" type="number" class="form-control" />
          ...
          <!-- mensaje -->
          <div id="divMensaje" class="mb-3 col-12 {{ old('validarEdad') ? '' : 'd-none' }}">
            <label class="form-label" for="mensaje">
             Describe el mensaje de error para la edad
            </label>
            <textarea onkeypress="return sinComillas(event)" id="mensaje" name="mensaje" placeholder="Escribe el mensaje" class="form-control" rows="2" maxlength="500" spellcheck="false" data-ms-editor="true" >{{ old('mensaje') }}</textarea>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="mb-3 col-12">
            ...
            <label class="switch switch-lg">
              <input id="habilitarTerminosCondiciones" name="términosCondiciones" placeholder="Habilitar términos y condiciones" type="checkbox" @checked(old('términosCondiciones')) class="switch-input switchTerminosCondiciones" />
              <span class="switch-toggle-slider">
                <span class="switch-on">SI</span>
                <span class="switch-off">NO</span>
              </span>
          ...
          <!-- terminosCondiciones -->
          <div id="divTerminosYCondiciones"  class="mb-3 col-12 {{ old('términosCondiciones') ? '' : 'd-none' }}">
            <label class="form-label" for="terminosYCondiciones">
              Escribe la descripción breve de los terminos y condiciones
            </label>
            <textarea onkeypress="return sinComillas(event)" id="terminosYCondiciones" name="términosYCondiciones" placeholder="Escribe los términos y condiciones" class="form-control" rows="2" maxlength="500" spellcheck="false" data-ms-editor="true" >{{ old('términosYCondiciones') }}</textarea>
          ...
          <div id="divUrlTerminosCondiciones" class="mb-3 col-12 {{ old('términosCondiciones')  ? '' : 'd-none' }}">
            <label class="form-label" for="urlTerminosCondiciones">
              Url de términos y condiciones
            </label>
            <input id="urlTerminosCondiciones" name="url" placeholder="Escribe la URL" value="{{ old('url') }}" type="text" class="form-control" />
            @if($errors->has('url'))
            <div class="text-danger ti-12px mt-2">
          ...
          <div id="divTerminosYCondicionesDatallado"  class="mb-3 col-12 {{ old('términosCondiciones')  ? '' : 'd-none' }}">
            ...
            <textarea onkeypress="return sinComillas(event)" id="terminosYCondicionesDetallado" name="términosYCondicionesDetallado" placeholder="Escribe los términos y condiciones" class="form-control d-none" spellcheck="false" data-ms-editor="true" >{{ old('términosCondicionesDetallado') }}</textarea>
