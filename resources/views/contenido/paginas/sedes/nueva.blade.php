  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card mb-4 rounded rounded-3">
        <img id="preview-foto" class="cropped-img card-img-top mb-2" src="{{ Storage::disk('global_media')->url('sedes/default.png') }}" alt="Portada">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mb-3 col-12 col-md-3">
            ...
            <input id="latitud" name="latitud" value="{{ old('latitud') }}" type="text" class="form-control" placeholder="Ej: 4.609710" />
          ...
          <div class="mb-3 col-12 col-md-3">
            ...
            <input id="longitud" name="longitud" value="{{ old('longitud') }}" type="text" class="form-control" placeholder="Ej: -74.081750" />
