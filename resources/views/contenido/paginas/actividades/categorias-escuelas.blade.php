...
@section('content')
<h4 class="mb-1 fw-semibold text-primary">Crear Categorías escuela</h4>
<p class="mb-4 text-dark">Aquí puedes gestionar las categorías de tu actividad: <b>{{ $actividad->nombre }}</b></p>
...
@livewire('Actividades.categorias-escuelas', [
'actividad' => $actividad,
])
