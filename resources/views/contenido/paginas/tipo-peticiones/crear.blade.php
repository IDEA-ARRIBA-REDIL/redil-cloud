...
@section('title', 'Crear tipo de petición')
...
<script type="module">
  $(function() {
    ...
    setupQuill('#editor_mensaje_1', '#mensaje_parte_1', `{!! old('mensaje_parte_1', '') !!}`);
    setupQuill('#editor_mensaje_2', '#mensaje_parte_2', `{!! old('mensaje_parte_2', '') !!}`);
  });
</script>
@endsection

@section('content')
<h4 class="fw-semibold text-primary mb-1">Nuevo tipo de petición</h4>
<p class="mb-4 text-black">Registra un nuevo tipo de petición en el sistema.</p>

@include('layouts.status-msn')

<form id="formulario" action="{{ route('tipo-peticiones.crear') }}" method="POST" enctype="multipart/form-data">
  @csrf
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-4 mb-3">
              ...
              <input type="text" name="nombre" id="nombre" class="form-control" value="{{ old('nombre') }}" placeholder="Ej: Petición de Salud" required>
              @error('nombre')
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" name="icono" id="icono" class="form-control" value="{{ old('icono') }}" placeholder="Ej: ti ti-heart">
              @error('icono')
              <div class="text-danger ti-12px mt-2"><i class="ti ti-circle-x"></i> {{ $message }}</div>
              @enderror
            </div>
            <div class="col-md-4 mb-3">
              ...
              <input type="number" name="orden" id="orden" class="form-control" value="{{ old('orden', 0) }}" placeholder="Ej: 1" required>
              @error('orden')
              <div class="text-danger ti-12px mt-2"><i class="ti ti-circle-x"></i> {{ $message }}</div>
              @enderror
            </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 mb-3">
              ...
              <input type="hidden" id="mensaje_parte_1" name="mensaje_parte_1" value="{{ old('mensaje_parte_1') }}">
            ...
            <div class="col-12 mb-3">
              ...
              <input type="hidden" id="mensaje_parte_2" name="mensaje_parte_2" value="{{ old('mensaje_parte_2') }}">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12">
              ...
              <input type="hidden" id="json_versiculos" name="json_versiculos" value="{{ old('json_versiculos', '[]') }}">
            </div>
          </div>
        </div>
      </div>
