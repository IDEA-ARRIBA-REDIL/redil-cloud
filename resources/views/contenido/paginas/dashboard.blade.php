...
<style>
  ...
  .birthday-sidebar {
    width: 40px !important; /* Ancho colapsado suficiente para ver el botón pequeño */
  ...
  .birthday-sidebar:hover {
    width: 60px !important; /* Ancho expandido */
  }
  ...
  .birthday-btn {
    ...
    transform: scale(0.6); /* Pequeño por defecto */
    transform-origin: center;
  }

  .birthday-sidebar:hover .birthday-btn {
    transform: scale(1); /* Tamaño normal al expandir */
  }
...
@section('content')
  ...
  <div class="d-md-block d-none">
    <div  class="birthday-sidebar shadow-md position-fixed z-3 d-flex align-items-center flex-column border  theme-bg-secondary vh-100" style=" z-index: 1090 !important; top: 0 !important; right: 0 !important; padding-top: 10px !important;">
      <a href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBirthday" class="birthday-btn d-flex align-items-center justify-content-center" title="Ver cumpleaños">
  ...
  <div style="" class="offcanvas offcanvas-end theme-bg-secondary" tabindex="-1" id="offcanvasBirthday" aria-labelledby="offcanvasBirthdayLabel">
  ...
  <div class="row  me-md-3">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide mb-5">
              ...
              <div class="card shadow-none border-0 overflow-hidden rounded-3 position-relative">
                  <img class="img-fluid w-100 object-fit-cover" style="height: 350px;" src="{{ Storage::url($configuracion->ruta_almacenamiento . '/img/banners/' . $banner->imagen) }}" alt="{{ $banner->nombre }}">
                  <div class="card-img-overlay d-flex flex-column justify-content-end p-4" style="background: linear-gradient(to top, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0) 60%);">
    ...
    <div class="col-12 col-lg-6 mt-3">
      ...
      <div class="card rounded shadow mt-3 overflow-hidden">
        <div class="row g-0">
          <div class="col-3">
            <img class="img-fluid w-100 h-100 object-fit-cover rounded-start" src="https://demos.pixinvent.com/vuexy-html-laravel-admin-template/demo/assets/img/elements/12.png" alt="Card image">
          </div>
          <div class="col-9 bg-warning bg-opacity-25">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('ruedaDeLaVida.gestor') }}" class="btn btn-icon rounded-pill btn-text-dark waves-effect">
                  <i class="ti ti-chevron-right"></i>
                </a>
              </div>
              
              <small class="card-text text-black">Establece tus metas y mejora tu promedio con Dios.</small>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-12 col-md-6 mb-3">
      <div class="card h-100 rounded-3 shadow mt-3 overflow-hidden border-0" style="border-radius: 15px;">
        <div class="card-img-top-wrapper position-relative overflow-hidden" style="width: 100%; height: 0; padding-bottom: 100%; background-color: #f8f9fa;">
          <img 
            src="{{ Storage::url($configuracion->ruta_almacenamiento . '/img/dashboard/tiempo-con-dios-card.png') }}" 
            class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover" 
            alt="Árbol de engranajes"
          >
        </div>
        ...
        <div class="card-body bg-white px-5 py-2">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('tiempoConDios.historial') }}" class="btn btn-outline-dark rounded-pill px-4 text-decoration-none" style="font-size: 0.85rem;">
              Comenzar
            </a>
          </div>
        </div>
                    ...
                    <div class="card border rounded-3 shadow-sm h-100">
                      <div class="card-body">
                        <div class="d-flex flex-row justify-content-between mb-2">
                          <p class="fw-semibold text-black text-truncate mb-0">{{ $actividad->nombre }}</p>
                          <span class="badge rounded-pill bg-label-info">{{ $actividad->tipo->es_gratuita ? 'Gratuita' : 'De pago' }}</span>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-7">
                                <small class="text-black d-block">Fecha:</small>
                                <small class="fw-bold">{{ \Illuminate\Support\Carbon::parse($actividad->fecha_inicio)->format('d-m-Y') }}</small>
                            </div>
                            <div class="col-5 text-end">
                                <a href="{{ route('actividades.perfil', $actividad->id) }}" class="btn btn-sm btn-primary rounded-pill">Ver más</a>
                            </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="col equal-height-col col-12">
                <div class="card border rounded-3 shadow-sm py-5">
                  <div class="card-body m-0 text-center">
                    <p class="text-black"> <i class="ti ti-calendar ti-lg me-2"></i>No hay actividades disponibles para ti en este momento.</p>
                  </div>
                </div>
            </div>
          </div>
      ...
      <div class="modal-dialog modal-md modal-dialog-centered modal-simple">
        <div class="modal-content p-0">
            ...
            <div class="row">
              ...
              <div class="col-12 mb-3">
                <small class="text-black">
                  Nos contaste que tienes hijos menores de edad. ¿Te gustaría registrarlos ahora? También puedes hacerlo más adelante desde el menú lateral, en la opción <b>Personas</b>.
                </small>
              </div>
              ...
              <div class="d-flex">
                ...
                <a href="{{ route('usuario.nuevo', $formulario) }}" type="button" class="btnGuardar btn btn-sm py-2 px-4 rounded-pill btn-primary waves-effect waves-light me-1">{{ $formulario->label }}</a>
                @endforeach
          ...
          <div class="modal-footer border-top p-5">
            <button id="no-volver-a-mostrar-btn" type="button" data-bs-dismiss="modal" class="btn btn-sm py-2 px-4 rounded-pill btn-outline-primary waves-effect">No volver a mostrar</button>
            <button type="button" data-bs-dismiss="modal" class="btn btn-sm py-2 px-4 rounded-pill btn-outline-secondary waves-effect">Cerrar</button>
          </div>
        </div>
      </div>
    </div>
