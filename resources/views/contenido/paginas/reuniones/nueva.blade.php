...
@section('content')
    ...
    <form id="formulario" role="form" class="forms-sample" method="POST" action="{{ route('reuniones.crear') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-12">
          <div class="card mb-4 rounded rounded-3">
            ...
            <div class="row p-4 m-0 d-flex card-body">
              <h5 class="mb-1 fw-semibold text-black">Nuevo reunión</h5>
              <p class="mb-4 text-black">Aquí podras crear las diferentes reuniones que realiza la iglesia, por favor llena los campos que son requeridos. </p>
            </div>
          </div>
        </div>
        <!-- PORTADA -->
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 mb-3">
                          ...
                          <input id="nombre" name="nombre" type="text" value="{{ old('nombre') }}" class="form-control" placeholder="Ejemplo: Reunión familiar" aria-describedby="defaultFormControlHelp" />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                          ...
                          <select id="sede" name="LaSede" class="select2 form-select form-select-lg" data-allow-clear="true">
                            <option value="">Seleccione una sede</option>
                            @foreach ($sedes as $s)
                              <option value="{{ $s->id }}" {{ old('LaSede') == $s->id ? 'selected' : '' }}>{{ $s->nombre }}</option>
                            @endforeach
                          </select>
                          @if ($errors->has('LaSede'))
                              <div class="text-danger form-label">{{ $errors->first('LaSede') }}</div>
                          @endif
                        </div>
                        <!-- /sede -->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-sm-12 mb-3">
                          ...
                          <select id="dia" name="día" class="select2 form-select" data-allow-clear="true">
                            ...
                            @foreach (Helper::diasDeLaSemana() as $dia)
                              <option value="{{$dia->id}}" {{ old('día')==$dia->id ? 'selected' : '' }}>{{$dia->nombre}}</option>
                            @endforeach
                          </select>
                          @if ($errors->has('día'))
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                          ...
                          <input class="form-control" name="hora" type="time" value="{{ old('hora','12:30') }}" id="hora" />
                          @if ($errors->has('hora'))
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3 ">
                            ...
                            <input class="form-control" name="díasDePlazo" type="number" value="{{ old('díasDePlazo') }}" id="diasDePlazo" />
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3">
                            ...
                            <input class="form-control" name="horaMáxima" type="time" value="{{ old('horaMáxima','12:30') }}" id="horaMaxima" />
                        </div>
                        <!-- /HoraMaxima -->
                        ...
                        <div class="col-12 mb-3">
                          ...
                          <textarea rows="3" class="form-control w-100" id="descripcion" name="descripción">{{ old('descripción') }}</textarea>
                        </div>
                        <!-- /descripción -->

                        <!-- /selectSedes -->
                        <div class="col-12 mb-3">
                            <label for="selectSedes" class="form-label my-3">¿Qué sedes pueden asistir?
                              <a href="javascript:;" data-select="selectSedes" class="ms-1 selectAllItems"><span class="fw-medium">Seleccionar todas</span></a> |
                              <a href="javascript:;" data-select="selectSedes" class="clearAllItems"><span class="fw-medium">Quitar todas</span></a>
                            </label>
                            <div class="select2-primary">
                              <select id="selectSedes" name="sedesAsistentes[]" class="select2 form-select" multiple>
                                @foreach ($sedes as $s)
                                  <option value="{{ $s->id }}" {{ in_array($s->id, old('sedesAsistentes', [])) ? 'selected' : '' }}>{{ $s->nombre }}</option>
                                @endforeach
                              </select>
                            </div>
                        </div>
                        ...
                        <!-- /selectSexos -->
                        <div class="col-12 mb-3">
                          <label for="selectSexos" class="form-label my-3">¿Personas de qué sexo pueden asistir?
                            <a href="javascript:;" data-select="selectSexos" class="ms-1 selectAllItems"><span class="fw-medium">Seleccionar todos</span></a> |
                            <a href="javascript:;" data-select="selectSexos" class="clearAllItems"><span class="fw-medium">Quitar todos</span></a>
                          </label>
                          <div class="select2-primary">
                          ...
                          <div class="select2-primary">
                            <select id="selectRangoEdad" name="rangosEdad[]" class="select2 form-select" multiple>
                                @foreach ($tiposEdades as $tipoEdad)
                                    <option value="{{ $tipoEdad->id }}" {{ in_array($tipoEdad->id, old('rangosEdad', [])) ? 'selected' : '' }}> {{ $tipoEdad->nombre }}</option>
                                @endforeach
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="select2-primary">
                                <select id="selectTipoUsuarios" name="tipoUsuarios[]" class="select2 form-select" multiple>
                                    @foreach ($tipoUsuarios as $tu)
                                        <option value="{{ $tu->id }}" {{ in_array($tu->id, old('tipoUsuarios', [])) ? 'selected' : '' }}>{{ $tu->nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <select id="selectOfrendas" name="ofrendas[]" class="select2 form-select" multiple>
                                    @foreach ($ofrendas as $ofrenda)
                                        <option value="{{ $ofrenda->id }}"
                                            {{ in_array($ofrenda->id, old('ofrendas', [])) ? 'selected' : '' }}>
                                            {{ $ofrenda->descripcion }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <label for="selectClasificacionAsistentes" class="form-label my-3">Define las clasificaciones
                              <a href="javascript:;" data-select="selectClasificacionAsistentes" class="ms-1 selectAllItems"><span class="fw-medium">Seleccionar todas</span></a> |
                              <a href="javascript:;" data-select="selectClasificacionAsistentes" class="clearAllItems"><span class="fw-medium">Quitar todas</span></a>
                            </label>
                            <div class="select2-primary">
                                <select id="selectClasificacionAsistentes" name="clasificacionAsistentes[]"
                                    ...
                                    @foreach ($clasificacionesAsistentes as $ca)
                                        <option value="{{ $ca->id }}" {{ in_array($ca->id, old('clasificacionAsistentes', [])) ? 'selected' : '' }}>{{ $ca->nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="small mb-3 form-label">¿Habilitar reserva?</div>
                                <label class="switch switch-lg">
                                    <input type="checkbox" @checked(old('habilitarReserva')) class="switch-input"
                                        id="toggleReserva" name="habilitarReserva" />
                        ...
                        <div id="reservaConfig" class="{{ old('habilitarReserva') ? '' : 'd-none' }}">
                            ...
                            <div class="row align-items-center mt-4">
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="dias_plazo" name="díasPlazoReserva"
                                        value="{{ old('díasPlazoReserva') }}" placeholder="" />
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="small mb-3 form-label">¿Solo los que reservaron pueden asistir?</div>
                                    <label class="switch switch-lg">
                                        <input type="checkbox" class="switch-input" name="soloReservaronAsistir"
                                            @checked(old('soloReservaronAsistir')) />
                                        <span class="switch-toggle-slider">
                                            <span class="switch-on">Si</span>
                                            <span class="switch-off">No</span>
                                        </span>
                            ...
                            <div class="row align-items-center my-4">
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="small mb-3 form-label">¿Habilitar reserva a invitados?</div>
                                    <label class="switch switch-lg">
                                        <input type="checkbox" class="switch-input" id="toggleInvitados"
                                            name="habilitarReservaInvitados" @checked(old('habilitarReservaInvitados')) />
                                        <span class="switch-toggle-slider">
                                            <span class="switch-on">Si</span>
                                            <span class="switch-off">No</span>
                                        </span>
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="cantidad_invitados" name="cantidadInvitados" placeholder="" value="{{ old('cantidadInvitados') }}" />
                                    @if ($errors->has('cantidadInvitados'))
                                    <div class="text-danger form-label">{{ $errors->first('cantidadInvitados') }}</div>
                                    @endif
                                </div>

                                <div class="col-12 col-md-4 mb-3">
                                  <div class="small mb-3 form-label">¿Habilitar reserva a familiares?</div>
                                  <label class="switch switch-lg">
                                      <input type="checkbox" class="switch-input" id="toggleReservaFamiliares"
                                          name="habilitarReservaFamiliares" @checked(old('habilitarReservaFamiliares')) />
                                      <span class="switch-toggle-slider">
                                          <span class="switch-on">Si</span>
                                          <span class="switch-off">No</span>
                                      </span>
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div class="small mb-4 form-label">¿Habilitar el preregistro a la iglesia infantil?</div>
                            <label class="switch switch-lg">
                                <input type="checkbox" class="switch-input" id="toggleInvitados"
                                    name="habilitarPreregistroInfantil" @checked(old('habilitarPreregistroInfantil')) />
                                <span class="switch-toggle-slider">
                                    <span class="switch-on">Si</span>
                                    <span class="switch-off">No</span>
                                </span>
