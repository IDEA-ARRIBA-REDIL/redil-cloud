...
@section('title', 'Tipo de Servicio de Actividad')
  ...
  <div class="row g-4 mb-4">
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start mb-3">
            ...
            <div class="d-flex gap-2">
              ...
              <!-- Botón Eliminar -->
              <form action="{{ route('tipo-servicio-actividad.eliminar', $servicio->id) }}" method="POST" class="m-0">
                @csrf
                @method('DELETE')
    ...
    <div class="col-12">
      <div class="card border">
        <div class="card-body">
          <center>
            <i class="ti ti-calendar-star fs-1 pb-1"></i>
            <h6 class="text-center">No hay tipos de servicios de actividad registrados.</h6>
          </center>
        </div>
      </div>
    </div>
...
<div class="modal fade" id="modalCrear" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{ route('tipo-servicio-actividad.crear') }}" method="POST">
        @csrf
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label class="form-label">Nombre</label>
            <input type="text" name="nombre" class="form-control" placeholder="Ej: Ujier" required>
          </div>
        </div>
        <div class="modal-footer">
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.btn-editar').forEach(button => {
      button.addEventListener('click', function() {
        ...
        form.action = "{{ route('tipo-servicio-actividad.actualizar', ':id') }}".replace(':id', id);
      });
    });
  });
</script>
