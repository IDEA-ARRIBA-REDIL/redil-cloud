  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card mb-4 rounded rounded-3">
        <img id="preview-foto" class="cropped-img card-img-top mb-2" src="{{ Storage::url($configuracion->ruta_almacenamiento.'/img/grupos/'.$grupo->portada) }}" alt="Portada {{$grupo->titulo}}">
        ...
        <div class="row p-4 m-0 d-flex card-body">
          <h5 class="mb-1 fw-semibold text-black">Modificar grupo</h5>
          <p class="mb-4 text-black">Aquí podras editar el grupo, por favor llena los campos que son requeridos.</p>
        </div>
      </div>
    </div>
    <!-- PORTADA -->
