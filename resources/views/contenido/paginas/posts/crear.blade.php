  ...
  <div class="row mt-10">
            ...
            <div class="row">
              <div class="mb-3 col-md-12 d-flex justify-content-center align-items-center flex-column">
                  <div class="position-relative d-inline-block">
                      <img id="preview-foto" src="{{ asset('assets/img/illustrations/page-pricing-enterprise.png') }}" alt="Preview" class="rounded border shadow-sm" style="width: 200px; aspect-ratio: 9/16; object-fit: cover;">
            ...
            <div class="row">
              ...
              <div class="mb-3 col-12 d-flex align-items-center">
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" id="visualizar_siempre" name="visualizar_siempre" value="1">
    ...
    <div class="col col-12 mb-4">
        <div class="card border shadow-none mb-0">
            <div class="card-header border-bottom py-2 cursor-pointer d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#collapseRestricciones" aria-expanded="false" aria-controls="collapseRestricciones">
                <h5 class="card-header text-black fw-semibold">
                ...
                <div class="card-body pt-3">
                    <div class="row g-3"> 
                        ...
                        <div class="col-12 mb-2">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="visible_todos" name="visible_todos" checked>
                                <label class="form-check-label w-100 cursor-pointer" for="visible_todos">
                                    ...
                                    <small class="d-block text-">Si se desactiva, solo los usuarios que cumplan los requisitos podrán verla.</small>
                                </label>
                            </div>
                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content" for="genero_ambos">
                                                    ...
                                                    <input name="genero" class="form-check-input" type="radio" value="3" id="genero_ambos" checked />
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content" for="genero_masculino">
                                                    ...
                                                    <input name="genero" class="form-check-input" type="radio" value="1" id="genero_masculino" />
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-check custom-option custom-option-icon">
                                                <label class="form-check-label custom-option-content" for="genero_femenino">
                                                    ...
                                                    <input name="genero" class="form-check-input" type="radio" value="2" id="genero_femenino" />
                                                </label>
                                            </div>
                                        </div>
                                    </div>
