            ...
            <div class="row">
              <div class="mb-3 col-md-12 d-flex justify-content-center align-items-center flex-column">
                  <div class="position-relative d-inline-block">
                      ...
                      @endphp
                      <img id="preview-foto" src="{{ $imgUrl }}" alt="Preview" class="rounded border" style="width: 200px; aspect-ratio: 9/16; object-fit: cover;">
          ...
          <div class="card-body">
            <div class="row">
              <div class="mb-3 col-md-12 col-12">
                ...
                <input type="hidden" name="version_uri" id="version_uri" value="{{ $versiculo->version_uri }}">
                <input type="hidden" name="libro_nombre" id="libro_nombre" value="{{ $versiculo->libro_nombre }}">
                <input type="hidden" name="cita_referencia" id="cita_referencia" value="{{ $versiculo->cita_referencia }}">
              </div>
              ...
              <div class="mb-3 col-md-12 col-12">
                ...
                <input type="hidden" id="texto_versiculo" name="texto_versiculo" value="{{ json_encode($versiculo->texto_versiculo) }}">
              </div>          
              <div class="mb-3 col-md-4 col-12">
                <label for="fecha_publicacion" class="form-label">Fecha de Publicación</label>
                <input type="text" class="form-control" id="fecha_publicacion" name="fecha_publicacion" value="{{ $versiculo->fecha_publicacion ? $versiculo->fecha_publicacion->format('Y-m-d') : '' }}" required />
              </div>

              <div class="mb-3 col-md-8 col-12">
                <label for="url_video_reflexion" class="form-label">URL Video de Reflexión (YouTube/Vimeo)</label>
                <input class="form-control" type="url" id="url_video_reflexion" name="url_video_reflexion" value="{{ $versiculo->url_video_reflexion }}" />
              </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="col-12 text-center">
          <button type="button" class="btn btn-primary crop me-sm-3 me-1" data-bs-dismiss="modal">Guardar</button>
          <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal" aria-label="Close">Cancelar</button>
        </div>
      </div>
    </div>
  </div>
