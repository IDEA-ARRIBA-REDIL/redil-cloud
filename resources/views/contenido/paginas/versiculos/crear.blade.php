...
@section('title', 'Crear Versículo Diario')
    ...
    $(function () {
        ...
        Livewire.on('bibliaSeleccionada', (data) => {
            if (data && data.length > 0) {
                ...
                // Renderizamos la previsualización
        ...
        function renderizarPrevisualizacionVersiculo(data) {
            const container = document.getElementById('preview-versiculo-container');
...
<h4 class="mb-1 fw-semibold text-primary">Nuevo versículo diario</h4>

@include('layouts.status-msn')

<form action="{{ route('versiculos.store') }}" method="POST" enctype="multipart/form-data" id="formulario">
  @csrf
  <div class="row mt-10">
    <div class="col-md-4">
      <div class="card mb-4">
            ...
            <div class="row">
              <div class="mb-3 col-md-12 d-flex justify-content-center align-items-center flex-column">
                  <div class="position-relative d-inline-block">
                      <img id="preview-foto" src="{{ asset('assets/img/illustrations/page-pricing-enterprise.png') }}" alt="Preview" class="rounded border" style="width: 200px; aspect-ratio: 9/16; object-fit: cover;">
                      <button type="button" class="btn btn-sm btn-icon btn-primary rounded-circle position-absolute bottom-0 end-0 mb-n2 me-n2" data-bs-toggle="modal" data-bs-target="#modalFoto">
          ...
          <div class="card-body">
            <div class="row">
              <div class="mb-3 col-md-12 col-12">
                <label class="form-label">Seleccionar Versículo de la Biblia</label>
                @livewire('TiempoConDios.biblia', [
                  'name_id' => 'referencia_biblica',
                  'despacharEvento' => true
                ])
                
                <!-- Hidden fields that will be populated via JS when selection changes -->
              ...
              <div class="mb-3 col-md-12 col-12">
                ...
                <div class="border rounded p-3" id="preview-versiculo-panel" style="min-height: 100px;">
                  <div id="placeholder-versiculo" class="text-black text-center py-4">
                    Selecciona un versículo arriba para ver la previsualización...
                  </div>
                  <div id="content-versiculo" class="d-none">
                    <h6 id="preview-cita" class="fw-bold mb-2 text-primary"></h6>
                    <p id="preview-texto-versiculos" class="mb-0 text-dark" style="line-height: 1.6; text-align: justify;"></p>
                  </div>
                </div>
              ...
              <div class="mb-3 col-md-4 col-12">
                ...
                <input type="text" class="form-control" id="fecha_publicacion" name="fecha_publicacion" placeholder="YYYY-MM-DD" required />
              </div>

              <div class="mb-3 col-md-8 col-12">
                <label for="url_video_reflexion" class="form-label">URL Video de Reflexión (YouTube/Vimeo)</label>
                <input class="form-control" type="url" id="url_video_reflexion" name="url_video_reflexion" placeholder="https://www.youtube.com/watch?v=..." />
              </div>
