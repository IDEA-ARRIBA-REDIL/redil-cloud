...
@section('content')
    ...
    <div class="row mb-5 mt-5">
        <div class="me-auto ">
            <h4 class="mb-1 fw-semibold text-primary">Horarios materia</h4>
            ...
            <div class="card mb-10 p-1 border-1">
                <ul class="nav nav-pills justify-content-start flex-column flex-md-row  gap-2">
                    ...
                    <li class="nav-item flex-fill"><a id="tap-horarios"
                            ...
                            class="nav-link p-3 waves-effect waves-light active" data-tap="horarios"><i
    ...
    <div class="row mb-5 mt-5">
        <div class="me-auto ">
            <h4 class="mb-1 fw-semibold text-black">Datos de horarios</h4>
            <p class=" text-black">aqui podras crear y gestionar los horarios de la materia:<b> {{ $materia->nombre }} </b>
            </p>
        </div>
    </div>
