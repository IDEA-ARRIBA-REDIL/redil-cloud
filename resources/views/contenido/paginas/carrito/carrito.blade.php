...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-menu-theme p-3 row justify-content-md-center">
        ...
        <div class="col-6 pl-5 text-center">
            <h5 id="tituloPrincipal" class="text-white my-auto fw-normal">@if($actividad->tipo->es_gratuita) Proceso de registro @else Carrito de compras @endif</h5>
        </div>
            ...
            <div class="p-4 col-12">
                <div class="d-flex align-items-start p-2 mt-1">
                    ...
                    <div class="my-auto ms-1 ">
                        ...
                        <h6 class="mb-0"> @if($actividad->tipo->es_gratuita) Proceso de registro @else Carrito @endif </h6>
                    </div>
                </div>
