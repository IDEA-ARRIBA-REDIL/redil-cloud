...
<nav class="navbar navbar-expand-lg navbar-light bg-menu-theme p-3 row justify-content-md-center">
  ...
  <div class="col-6 pl-5 text-center">
    ...
    <h5 id="tituloPrincipal" class="text-white my-auto fw-normal">Carrito de matrícula</h5>
    @else
    <h5 id="tituloPrincipal" class="text-white my-auto fw-normal">Carrito de compras</h5>
    @endif
  </div>
