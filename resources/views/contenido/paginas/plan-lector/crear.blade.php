...
@section('title', 'Nuevo plan lector')
        ...
        $(function() {
            ...
            $('#formulario').submit(function() {
                ...
                Swal.fire({
                    ...
                    text: "Estamos guardando el plan lector...",
                    icon: "info",
...
@section('content')
    ...
    <h4 class="mb-1 fw-semibold text-primary">Nuevo plan lector</h4>

    @include('layouts.status-msn')

    <form action="{{ route('planes-lectores.nuevo') }}" method="POST" enctype="multipart/form-data" id="formulario">
        @csrf
        <div class="row mt-10">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-12">
                                ...
                                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ej: Juan: El Evangelio del Amor" required value="{{ old('titulo') }}">
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div id="editor-descripcion">{!! old('descripcion') !!}</div>
