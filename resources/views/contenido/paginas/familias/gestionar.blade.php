...
@section('page-script')
    <script type="module">
        window.abrirModalActualizarPariente = function(relacionId, usuarioId) {
            Livewire.dispatch('abrirModalActualizarPariente', {
...
@section('content')
    ...
    <h4 class="mb-1 fw-semibold text-primary">Gestionar relaciones familiares</h4>
    <p class="mb-4 text-black">Aquí podrás crear las relaciones familiares de tu congregación.</p>
    ...
    <div class="row">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="text-black fw-semibold">
                        <i class="ti ti-user ms-n1 me-2"></i>Seleccione el usuario
                    </h5>
                </div>
        ...
        <div class=" col-lg-8 col-md-7 col-xs-12">
            ...
            <div class="card mb-4">
                <h5 class="card-header text-black fw-semibold">
                    <i class="ti ti-home-star ms-n1 me-2"></i>Mis relaciones familiares
                </h5>
                                ...
                                <div class="col-lg-4 col-md-12 col-xs-12">
                                    <div class="card border rounded">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);"
                                                        onclick="abrirModalActualizarPariente('{{ $pariente->id }}', '{{ $userId }}')"
                                                ...
                                                <li>
                                                    <a data-id="{{ $pariente->id }}" data-nombre=""
                                                        class=" confirmacionEliminar dropdown-item text-danger">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <span class="pb-1"><span></span><b>Relación:</b>
                                                {{ $usuario->genero == 0 ? $pariente->nombre_masculino : $pariente->nombre_femenino }}
                                                de </span>
                                            <h4 class="mb-1 card-title lh-sm">{{ $pariente->nombre(3) }}</h4>

                                            <div class="d-flex align-items-center justify-content-center my-3 gap-2">
                                                <span>¿Soy el responsable?</span>
                                                @if ($pariente->es_el_responsable)
                                                    <a href="javascript:;" class="me-1"><span
                                                            class="badge bg-label-success">Si</span></a>
                                                @else
                                                    <a href="javascript:;"><span
                                                            class="badge bg-label-secondary">No</span></a>
                                                @endif
                                            </div>
        ...
        @if ($userId)
            ...
            <form class="forms-sample" method="GET" action="{{ route('familias.crear') }}">
                <div class="offcanvas offcanvas-end event-sidebar modalSelect2" tabindex="-1" id="modalNuevaRelacion"
                    aria-labelledby="modalNuevaRelacionLabel">
                    ...
                    <div class="offcanvas-body pt-6 px-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mt-3">
                                <div class="mb-3">
                                    <label class="form-label">¿Qué relación tiene <b>{{ $usuario->nombre(3) }}</b> con el
                                        pariente?</label>
                                    <select id="tipoParentesco" name="tipoParentesco" class="form-select" tabindex="0"
                                        id="roleEx7">
                            ...
                            <div class="col-lg-12 col-md-12  col-sm-12  mt-3">
                                <div class="mb-3">
                                    ...
                                    <select id="responsabilidad" name="responsabilidad" class="form-select" tabindex="0"
                                        id="roleEx7">
                                        <option value="1">Ninguna</option>
                                        <option value="2"><b>{{ $usuario->nombre(3) }}</b> es el responsable del
                                            pariente</option>
                                        <option value="3"> El pariente es el responsable de
                                            <b>{{ $usuario->nombre() }} </b></option>
                                    </select>
                                </div>
                            </div>

                            @if (isset($userId))
                                <input id="parientePrincipal" name="parientePrincipal" class="d-none"
                                    value="{{ $userId }}">
                            @endif
                        </div>
                    </div>
