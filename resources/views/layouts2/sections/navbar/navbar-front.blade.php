...
<nav style="height: 70px;
  ...
  <div class="container-xxl">
    <div class="navbar navbar-expand-lg pt-1 pb-0 landing-navbar">
      ...
      <div class="navbar-brand app-brand demo d-flex me-4 me-xl-8">
      ...
      <!-- Menu wrapper: Start -->
      <div style="display:none !important" id="container-nav-front">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <!-- navbar button: Start -->
        <li>
          <a href="{{ route('login', ['redirect' => url()->full()]) }}" class="btn btn-primary rounded-pill wave-effects" target="_blank">
