...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme-escuelas">
    <div class="app-brand demo">
        <a href="{{ url('/') }}" class="app-brand-link">
            ...
            <span style='color:{{ config('variables.templateNameColor') }} !important' class="app-brand-text demo menu-text fw-bold fs-4 pt-3">{{ config('variables.templateName') }}</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        {{-- Niveles Agrupados (Visible solo en contexto de escuela específica) --}}
        @if(isset($escuela) && $escuela->tipo_matricula == 'niveles_agrupados')
        <li class="menu-item @if(request()->routeIs('escuelas.niveles.*')) active @endif">
            <a href="{{ route('escuelas.niveles.index', $escuela) }}" class="menu-link">
                <i class="menu-icon ti ti-hierarchy"></i>
                <div>Grados</div>
            </a>
        </li>
        @endif
